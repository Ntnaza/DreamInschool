module.exports = [
"[project]/lib/data:500422 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$500422__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/data:500422 [app-ssr] (ecmascript) <text/javascript>");
...
function IDCardClient({ initialMembers }) {
    ...
    // Default pilih member pertama kalau ada
    ...
    const [backBackground, setBackBackground] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    // STATE PRINT MODE
    ...
    const handleFrontUpload = async (e)=>{
        ...
        if (file) {
            // Validasi ukuran (max 2MB biar db gak meledak)
            if (file.size > 2 * 1024 * 1024) return alert("Ukuran gambar maksimal 2MB!");
            const reader = new FileReader();
            reader.onloadend = async ()=>{
                const base64 = reader.result;
                // 1. Update Tampilan (Optimistic)
                setMemberList((prev)=>prev.map((m)=>m.id === selectedId ? {
                            ...m,
                            frontDesign: base64
                        } : m));
                // 2. Simpan ke Database Permanen
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$500422__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateIdCardDesign"])(selectedId, base64);
            };
    ...
    const handleRemoveFrontDesign = async ()=>{
        if (confirm("Hapus desain kustom ini?")) {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$500422__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateIdCardDesign"])(selectedId, null);
        }
    };
    ...
    const BackCardOriginal = ({ member, variant = 'preview' })=>{
        ...
        // Data untuk QR Code (Pakai NIS biar unik)
...
//# sourceMappingURL=_00bed56b._.js.map