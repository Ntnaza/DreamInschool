...
async function createBerita(formData) {
    ...
    const adminUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].user.findFirst();
    if (!adminUser) {
        return {
            success: false,
            message: "Error: Belum ada User/Admin di database!"
        };
    }
    try {
...
async function kembalikanBarang(formData) {
    ...
    try {
        ...
        const barang = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].inventaris.findUnique({
            where: {
                id
            }
        });
        if (!barang || !barang.peminjam) return {
            success: false,
            message: "Data tidak valid."
        };
        // A. Simpan ke Riwayat
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].riwayatAset.create({
            data: {
                inventarisId: id,
...
"[project]/.next-internal/server/app/admin/absensi/page/actions.js { ACTIONS_MODULE0 => \"[project]/lib/auth.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/lib/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/admin/absensi/page/actions.js { ACTIONS_MODULE0 => \"[project]/lib/auth.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/lib/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "407dfa88239647bb7a0c261efad9599ece274a7c63",
