...
"[project]/lib/data:9066a2 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/data:175cd2 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/data:1f6d53 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$9066a2__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/data:9066a2 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$175cd2__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/data:175cd2 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$1f6d53__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/data:1f6d53 [app-ssr] (ecmascript) <text/javascript>");
"use client";
;
;
;
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            if (modalType === 'general_in' || modalType === 'general_out') {
                ...
                result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$9066a2__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createGeneralTrx"])(data);
            } else if (modalType === 'new_event') {
                if (Number(formData.amount) > saldoUmum) {
                    setIsSubmitting(false);
                    return alert("Saldo Kas Umum tidak cukup!");
                }
                result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$175cd2__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createEventBudget"])(data);
            } else if (modalType === 'event_trx' && selectedEventId) {
                data.append("eventId", selectedEventId.toString());
                result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$1f6d53__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createEventTrx"])(data);
            }
            if (result?.success) {
...
//# sourceMappingURL=_1a63a343._.js.map