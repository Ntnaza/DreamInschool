...
async function trackVisitor(ip, userAgent, path) {
    // Jangan hitung kunjungan ke folder admin atau api
    if (path.startsWith('/admin') || path.startsWith('/api') || path.includes('_next')) {
        return;
    }
    try {
        // Cek apakah IP ini sudah berkunjung dalam 1 jam terakhir ke path yang sama
        // (Biar tidak spamming views saat refresh)
...
"[project]/.next-internal/server/app/admin/inventaris/page/actions.js { ACTIONS_MODULE0 => \"[project]/lib/auth.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/lib/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/admin/inventaris/page/actions.js { ACTIONS_MODULE0 => \"[project]/lib/auth.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/lib/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
