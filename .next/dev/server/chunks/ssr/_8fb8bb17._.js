...
"[project]/lib/data:37d06b [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/data:41bb33 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/data:1b7bb7 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$37d06b__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/data:37d06b [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$41bb33__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/data:41bb33 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$1b7bb7__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/data:1b7bb7 [app-ssr] (ecmascript) <text/javascript>");
"use client";
;
;
;
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            if (modalType === 'general_in' || modalType === 'general_out') {
                ...
                result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$37d06b__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createGeneralTrx"])(data);
            } else if (modalType === 'new_event') {
                if (Number(formData.amount) > saldoUmum) {
                    setIsSubmitting(false);
                    return alert("Saldo Kas Umum tidak cukup!");
                }
                result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$41bb33__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createEventBudget"])(data);
            } else if (modalType === 'event_trx' && selectedEventId) {
                data.append("eventId", selectedEventId.toString());
                result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$1b7bb7__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createEventTrx"])(data);
            }
            if (result?.success) {
...
//# sourceMappingURL=_8fb8bb17._.js.map