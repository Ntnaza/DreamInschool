...
function DashboardUI({ stats, agenda, transaksiTerakhir, aspirasi, chartData }) {
    ...
    const handleReply = async (id)=>{
        ...
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$fdbd92__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["replyAspirasi"])(formData);
        if (res.success) {
            setReplyingTo(null);
            setReplyText("");
...
//# sourceMappingURL=_069cbf88._.js.map