...
"[project]/lib/data:b0d8cc [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$b0d8cc__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/data:b0d8cc [app-client] (ecmascript) <text/javascript>");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function DashboardUI({ stats, agenda, transaksiTerakhir, aspirasi, chartData }) {
    ...
    const handleReply = async (id)=>{
        ...
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$b0d8cc__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["replyAspirasi"])(formData);
        if (res.success) {
            setReplyingTo(null);
            setReplyText("");
...
//# sourceMappingURL=_43dbf581._.js.map