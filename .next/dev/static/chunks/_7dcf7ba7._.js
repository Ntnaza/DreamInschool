...
"[project]/lib/data:805213 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/data:da0e29 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$805213__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/data:805213 [app-client] (ecmascript) <text/javascript>"); // ✅ Import Action
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$da0e29__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/data:da0e29 [app-client] (ecmascript) <text/javascript>");
;
...
;
;
// ... (Simpan array tourSteps Koh disini) ...
const tourSteps = [
    {
    ...
    },
    {
        ...
        content: 'Proker yang masih rencana (0%).',
        placement: 'right'
    },
    {
...
function ProkerClient({ initialData }) {
    _s();
    // ✅ Gunakan data dari Database, bukan dummy
    ...
    // Update state jika database berubah (saat refresh)
    ...
    const handleSave = async ()=>{
        ...
        formData.append("pic", formState.pic);
        formData.append("budget", formState.budget.toString());
        formData.append("progress", formState.progress.toString());
        // ✅ Panggil Server Action
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$805213__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["saveProker"])(formData);
        setIsSaving(false);
        if (res.success) {
            alert(res.message);
            setIsModalOpen(false);
            window.location.reload(); // Refresh biar data baru muncul dari server
        } else {
            alert(res.message);
        }
    };
    const handleDelete = async (id)=>{
        if (confirm("Hapus program kerja ini?")) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$da0e29__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteProker"])(id);
            setProkers(prokers.filter((p)=>p.id !== id)); // Optimistic update
        }
    };
    // Filter Logic
    ...
    const listSegera = filteredProkers.filter((p)=>p.status === 'segera' || p.progress === 0);
    const listBerjalan = filteredProkers.filter((p)=>p.status === 'berjalan' || p.progress > 0 && p.progress < 100);
    const listSelesai = filteredProkers.filter((p)=>p.status === 'selesai' || p.progress === 100);
...
} // ... (JANGAN LUPA COPY function KanbanColumn dan ProkerCard ke sini juga di paling bawah) ...
 // ... Copy fungsi komponen KanbanColumn & ProkerCard dari kode Koh sebelumnya ...
...
//# sourceMappingURL=_7dcf7ba7._.js.map