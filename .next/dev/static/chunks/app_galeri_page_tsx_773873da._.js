...
"[project]/app/galeri/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function GaleriPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GaleriPage.useEffect": ()=>{
            const handleKeyDown = {
                "GaleriPage.useEffect.handleKeyDown": (e)=>{
                    if (!selectedItem) return;
                    if (e.key === "Escape") closeModal();
                    if (e.key === "ArrowRight") setCurrentImageIndex({
                        "GaleriPage.useEffect.handleKeyDown": (prev)=>(prev + 1) % selectedItem.album.length
                    }["GaleriPage.useEffect.handleKeyDown"]);
                    if (e.key === "ArrowLeft") setCurrentImageIndex({
                        "GaleriPage.useEffect.handleKeyDown": (prev)=>(prev - 1 + selectedItem.album.length) % selectedItem.album.length
                    }["GaleriPage.useEffect.handleKeyDown"]);
                }
            }["GaleriPage.useEffect.handleKeyDown"];
            window.addEventListener("keydown", handleKeyDown);
            return ({
                "GaleriPage.useEffect": ()=>window.removeEventListener("keydown", handleKeyDown)
            })["GaleriPage.useEffect"];
        }
    }["GaleriPage.useEffect"], [
        selectedItem
...
_s(GaleriPage, "4kbEhNMdwJ3IPQ16M5YbGOD3hW0=");
_c = GaleriPage;
var _c;
__turbopack_context__.k.register(_c, "GaleriPage");
...
//# sourceMappingURL=app_galeri_page_tsx_773873da._.js.map