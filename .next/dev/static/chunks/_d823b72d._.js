...
"[project]/lib/data:6af726 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/data:d3185f [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/data:b5db3e [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$6af726__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/data:6af726 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$d3185f__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/data:d3185f [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$b5db3e__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/data:b5db3e [app-client] (ecmascript) <text/javascript>");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            if (modalType === 'general_in' || modalType === 'general_out') {
                ...
                result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$6af726__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createGeneralTrx"])(data);
            } else if (modalType === 'new_event') {
                if (Number(formData.amount) > saldoUmum) {
                    setIsSubmitting(false);
                    return alert("Saldo Kas Umum tidak cukup!");
                }
                result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$d3185f__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createEventBudget"])(data);
            } else if (modalType === 'event_trx' && selectedEventId) {
                data.append("eventId", selectedEventId.toString());
                result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$b5db3e__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createEventTrx"])(data);
            }
            if (result?.success) {
...
//# sourceMappingURL=_d823b72d._.js.map