...
"[project]/lib/data:c08523 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$c08523__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/lib/data:c08523 [app-client] (ecmascript) <text/javascript>");
...
function ScanClient() {
    ...
    const [kegiatan, setKegiatan] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("Absensi Harian");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ScanClient.useEffect": ()=>{
            ...
            const startScanner = {
                "ScanClient.useEffect.startScanner": async ()=>{
                    try {
                        await html5QrCode.start({
                            ...
                            "ScanClient.useEffect.startScanner": (decodedText)=>{
                                handleScan(decodedText);
                            }
                        }["ScanClient.useEffect.startScanner"], {
                            "ScanClient.useEffect.startScanner": (errorMessage)=>{
                ...
                "ScanClient.useEffect": ()=>{
                    if (scannerRef.current && scannerRef.current.isScanning) {
                        scannerRef.current.stop().catch({
                            "ScanClient.useEffect": (err)=>console.error("Gagal stop scanner", err)
                        }["ScanClient.useEffect"]);
                    }
                }
            })["ScanClient.useEffect"];
    ...
    const handleScan = async (nis)=>{
        ...
        try {
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$3a$c08523__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["scanAbsensi"])(nis, kegiatan);
...
_s(ScanClient, "osqUr+YLG34eo3JmYVi++PNOcjQ=");
_c = ScanClient;
var _c;
...
//# sourceMappingURL=_86b9c846._.js.map